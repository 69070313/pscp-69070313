...
```text
ผมเข้าใจว่าโจทย์ต้องการให้รับค่าราคาอาหารมาเป็นintก่อนเสร็จแล้วนำไปคำนวณหาค่าservice chargeและvatแยกกันจากนั้นก็นำทั้ง3อันมาบวกกันตอนท้ายแล้วจะได้total costมาเสร็จแล้วก็printออกมาเป็นทศนิยม
```
...
```text
1.ผมรับค่าราคาอาหารมาก่อนเป็นint
2.ผมคิดว่าจะเอาinputมาหาค่าservice chargeก่อนเพื่อที่จะได้เช็คต่อได้ว่าถึงเกณฑ์ที่กำหนดไว้ไหม
3.ถ้าตรงตามconditionไหนก็ให้เข้าไปคำนวณvatต่อในconditionนั้น
4.นำค่าทั้ง3ตัวแปรมาบวกกันให้ได้totalcost
5.print outputออกมาเป็นทศนิยม2หลัก
```
...
```text
ใช้ตามแผนแรกที่วางไว้แต่ในตอนแรกคำนวณผิดพลาดตรงขั้นตอนคำนวณvatกับservice chargeนิดหน่อยเลยต้องมานั่งคิดวิธีคำนวณอีกที
```
...
```text
เพราะเลขดูเยอะและคำนวณยากซับซ้อน
```
...
```text
เพราะว่าเลขน้อยอาจทำให้มีการตกหล่น
```
