...
```text
โจทย์ให้ฉันกลับคำที่inputมากลับหน้าไปหลัง
input:
โปรแกรมรับคำๆหนึ่งมาเป็น word
output:
โปรแกรมควรกลับคำที่ได้
Constraints:
inputเป็นstring ฉันควรพิจารณาลำดับของแต่ละตัวและprintออกมาตามลำดับจากหลังไปหน้า
```
...
```text
step 1: อ่านค่าที่ได้เป็น str
step 2: เช็คว่าค่าที่ได้เป็น str รึเปล่า
step 3: ถ้าใช่ให้เข้าเงื่อนไข if
...
```text
วิธีสุดท้ายเหมือนแผนที่วางไว้ตอนแรกใช้ifแล้วนำเข้าprocessเพื่อกลับคำให้ได้output
```
...
```text
เพราะinputมีการสลับตัวใหญ่ตัวเล็กเพิ่มความซับซ้อน
```
...
```text
เพราะinputมีการใช้ตัวใหญ่อย่างเดียวแต่outputต้องการพิมพ์เล็กจึงมีความซับซ้อน
```
...
```text
เพราะมีการใช้ตัวเลขแทรกเพิ่มความซับซ้อน
```
